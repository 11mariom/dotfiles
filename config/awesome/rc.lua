...
tags = {
   names = {"home", "editor", "other"},
   layout = {layouts[2], layouts[10], layouts[1]}
}

for s = 1, screen.count() do
    tags[s] = awful.tag(tags.names, s, tags.layout)

    awful.tag.setmwfact(0.67, tags[s][1])
    awful.tag.seticon(awful.util.getdir("config") .. "/icons/tag_home.png", tags[s][1])
    awful.tag.seticon(awful.util.getdir("config") .. "/icons/tag_editor.png", tags[s][2])
    awful.tag.seticon(awful.util.getdir("config") .. "/icons/tag_other.png", tags[s][3])
end
-- }}}
...
clock_widget = awful.widget.textclock()

clock_image = wibox.widget.imagebox()
clock_image:set_image(awful.util.getdir("config") .. "/icons/clock.png")
...
vol_image:set_image(awful.util.getdir("config") .. "/icons/volume.png")
...
mpd_widget:buttons(awful.util.table.join(
	 ...
	 function () awful.util.spawn_with_shell("mpc prev") end),
      awful.button({ }, 3,
	 function () awful.util.spawn_with_shell("mpc next") end)
      ))
...
-- {{{
-- autostart
awful.util.spawn_with_shell(awful.util.getdir("config") .. "/runonce.sh")
-- }}}
